								...
								<form method="get" action="<?php echo U('Admin/Order/index');?>">
									<div class="col-sm-2">
										<select class="form-control" name="game">
											...
											<option value="bj28"  <?php if($game == 'bj28'): ?>selected<?php endif; ?> >盛發财富北京28</option>
											<option value="jnd28"  <?php if($game == 'jnd28'): ?>selected<?php endif; ?> >盛發财富加拿大28</option>
											<option value="lhc"  <?php if($game == 'lhc'): ?>selected<?php endif; ?> >六合彩</option>
											<option value="xjp28"  <?php if($game == 'xjp28'): ?>selected<?php endif; ?> >新加坡28</option>
										</select>
									</div>
									<div class="col-sm-2">
									...
									<tbody>
										<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												<td width="120" style="text-align: center;">
													<?php if($vo["game"] == 'ssc'): ?>重庆时时彩<?php endif; ?>
													<?php if($vo["game"] == 'pk10'): ?>北京赛车<?php endif; ?>
													<?php if($vo["game"] == 'er75sc'): ?>极速赛车<?php endif; ?>
													<?php if($vo["game"] == 'xyft'): ?>幸运飞艇<?php endif; ?>
													<?php if($vo["game"] == 'bj28'): ?>盛發财富北京28<?php endif; ?>
													<?php if($vo["game"] == 'jnd28'): ?>盛發财富加拿大28<?php endif; ?>
													<?php if($vo["game"] == 'xjp28'): ?>盛發财富新加坡28<?php endif; ?>
													<?php if($vo["game"] == 'lhc'): ?>六合彩<?php endif; ?>
												</td>
