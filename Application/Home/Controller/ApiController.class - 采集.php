...
class ApiController extends Controller
{
    ...
    public function _initialize()
    {
        ...
        $this->apiarr = array(
            ...
            3 => '',
            4 => '',
            5 => 'http://127.0.0.1/pcdd.php',
            6 => '',
			7 => 'http://127.0.0.1/jnd28.php'
			
        );
        // http://127.0.0.1/newly.do?token=t92f294b93daf64d3k&code=bjkl8&format=json
    }
    ...
    {
        $json_ori = http_get('http://127.0.0.1/Home/Lottery/index/token/d35b6b8cd98c74ee94efbc6898fbaf32/code/PCDD/format/xml/num/5/');
        $json = json_decode($json_ori, 1);
