...
function pk10_format($caiji){
	...
	$awardTime = $caiji['awardtime'];
	$awardNumbers = $caiji['awardnumbers'];
	if (strtotime($awardTime) < strtotime("23:51:00") && strtotime($awardTime) > strtotime("09:30:00")) {
		$n_awardTime = strtotime($awardTime) + 1200;
	} else {
...
function ssc_format($caiji){
	...
	if (strtotime($awardTime) > strtotime("03:10:00") && strtotime($awardTime) < strtotime("07:30:00")) {
		$n_awardTime = strtotime($awardTime) + 8*60*60;
	} else if(strtotime($awardTime) > strtotime("07:30:00") && strtotime($awardTime) < strtotime("21:50:00")){
		$n_awardTime = strtotime($awardTime) + 1200;
	} else {
		$n_awardTime = strtotime($awardTime) + 1200;
	}
