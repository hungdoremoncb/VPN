		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【六合彩】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
				...
				if($list){
					...
					$this->success('手动添加开盘成功，请查看竞猜记录该期的开盘结果!',U('Admin/Order/index'),1);
				}else{
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【北京赛车】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【极速赛车】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【幸运飞艇】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【重庆时时彩】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【北京28】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【加拿大28】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
		...
		if(IS_POST){
			if(!IS_AJAX){
				...
				$log = array(
					...
					'type' => 8,
					'addtime' => time(),
					'content' => "手动开盘【新加坡28】，期号【{$data['periodnumber']}】,开盘号码【{$data['awardnumbers']}】"
				);
				M('admin_log')->add($log);
