...
class SiteController extends BaseController {
	...
	//房间2
	public function xiazhu_jnd28_2(){
		if(IS_POST){
			$this -> sitesave('site.php');
		}else{
			$this->display();
	...
	//房间3
	public function xiazhu_jnd28_3(){
		if(IS_POST){
			$this -> sitesave('site.php');
		}else{
			$this->display();
	...
	//房间2
	public function xiazhu_xjp28_2(){
		if(IS_POST){
			$this -> sitesave('site.php');
		}else{
			$this->display();
	...
	//房间3
	public function xiazhu_xjp28_3(){
		if(IS_POST){
			$this -> sitesave('site.php');
		}else{
			$this->display();
